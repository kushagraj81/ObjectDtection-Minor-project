...
export class AppComponent implements OnInit {
  ...
  public modelArray: Array<object> = [
    { 'name': 'ResNet50', 'value': 'mobilenet_v1' },
  ...
  public title: string = 'Object Identification In An Image';
  public introline: string = 'Minor Project(Mentor :- Pradeep sir)';
  ...
  randomMath() { return (Math.random()*2).toFixed(2) }
